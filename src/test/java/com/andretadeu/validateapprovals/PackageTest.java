...
class PackageTest {
    ...
    @Test
    void testRootFolderNotFound() {
        assertThrows(
                FileNotFoundException.class, () -> new Package(Paths.get("/a/b/c"), Paths.get("")));
    }

    @Test
    void testRootFolderIsFile() {
        assertThrows(
                NotDirectoryException.class, () -> new Package(Paths.get("build.gradle"), Paths.get("")));
    }
    ...
    void testPackageNotFound() {
        assertThrows(
                FileNotFoundException.class, () ->
                        new Package(Paths.get("src/test/resources/data/repo_root"), Paths.get("/a/b/c")));
    }
    ...
    void testFollowGetLocation() throws FileNotFoundException, NotDirectoryException {
        Package pckg = new Package(
                Paths.get("src/test/resources/data/repo_root"),
                Paths.get("src/com/client/follow"));
        assertEquals(
                "src/com/client/follow",
    ...
    void testFollowGetDependencies() throws FileNotFoundException, NotDirectoryException {
        Package pckg = new Package(
                ...
                Paths.get("src/com/client/follow"));
        assertTrue(
                pckg.getDependencies().contains(Paths.get("src/com/client/user"))
        );
    }
    ...
    void testMessageGetDependencies() throws FileNotFoundException, NotDirectoryException {
        ...
        Path follow = Paths.get("src/com/client/follow");
        Path user = Paths.get("src/com/client/user");
    ...
    void testTweetGetLocation() throws FileNotFoundException, NotDirectoryException {
        Package pckg = new Package(
                Paths.get("src/test/resources/data/repo_root"),
                Paths.get("src/com/client/tweet"));
        assertEquals(
                "src/com/client/tweet",
                pckg.getLocation().toString());
    }
